export const paintingData = [
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    imgSrc: `./src/artworks/${i + 1}.jpg`, // `i + 1` is the painting number. We add 1 to the index because the index starts at 0 but we want the painting numbers to start at 1.
    ...
    info: {
      ...
      year: `Year ${i + 1}`,
      link: 'https://github.com/NandanHemanth',
    },
  })),
  // Back Wall
  ...Array.from({ length: 4 }, (_, i) => ({
