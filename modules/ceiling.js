...
export const createCeiling = (scene, textureLoader) => {
  ...
  const colorTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_Color.jpg"
  );
  const displacementTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_Displacement.jpg"
  );
  const aoTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_AmbientOcclusion.jpg"
  );
  const emissionTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_Emission.jpg"
  );
  const metalnessTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_Metalness.jpg"
  );
  const normalGLTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_NormalGL.jpg"
  );
  const roughnessTexture = textureLoader.load(
    "./src/OfficeCeiling005_4K-JPG/OfficeCeiling005_4K_Roughness.jpg"
  );
